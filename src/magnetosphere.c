 ...
 *            double precision loss in the large intermediate GMST value
...
#define WGS84_F         (1.0 / 298.257223563f)
...
static const WmmRecord WMM2025_DATA[] = {
    ...
    { 7,  0,     79.5f,     0.0,    -0.0,    0.0 },
    { 7,  1,    -77.0f,   -48.9f,    -0.1f,    0.6f },
    { 7,  2,     -8.8f,   -14.4f,    -0.1f,    0.5f },
    { 7,  3,     59.3f,    -1.0,     0.5f,   -0.8f },
    { 7,  4,     15.8f,    23.4f,    -0.1f,    0.0 },
    { 7,  5,      2.5f,    -7.4f,    -0.8f,   -1.0 },
    { 7,  6,    -11.1f,   -25.1f,    -0.8f,    0.6f },
    { 7,  7,     14.2f,    -2.3f,     0.8f,   -0.2f },
    { 8,  0,     23.2f,     0.0,    -0.1f,    0.0 },
    { 8,  1,     10.8f,     7.1f,     0.2f,   -0.2f },
    { 8,  2,    -17.5f,   -12.6f,     0.0,    0.5f },
    { 8,  3,      2.0,    11.4f,     0.5f,   -0.4f },
    { 8,  4,    -21.7f,    -9.7f,    -0.1f,    0.4f },
    { 8,  5,     16.9f,    12.7f,     0.3f,   -0.5f },
    { 8,  6,     15.0f,     0.7f,     0.2f,   -0.6f },
    { 8,  7,    -16.8f,    -5.2f,    -0.0,    0.3f },
    { 8,  8,      0.9f,     3.9f,     0.2f,    0.2f },
    { 9,  0,      4.6f,     0.0,    -0.0,    0.0 },
    { 9,  1,      7.8f,   -24.8f,    -0.1f,   -0.3f },
    { 9,  2,      3.0f,    12.2f,     0.1f,    0.3f },
    { 9,  3,     -0.2f,     8.3f,     0.3f,   -0.3f },
    { 9,  4,     -2.5f,    -3.3f,    -0.3f,    0.3f },
    { 9,  5,    -13.1f,    -5.2f,     0.0,    0.2f },
    { 9,  6,      2.4f,     7.2f,     0.3f,   -0.1f },
    { 9,  7,      8.6f,    -0.6f,    -0.1f,   -0.2f },
    { 9,  8,     -8.7f,     0.8f,     0.1f,    0.4f },
    { 9,  9,    -12.9f,    10.0f,    -0.1f,    0.1f },
    {10,  0,     -1.3f,     0.0,     0.1f,    0.0 },
    {10,  1,     -6.4f,     3.3f,     0.0,    0.0 },
    {10,  2,      0.2f,     0.0,     0.1f,   -0.0 },
    {10,  3,      2.0,     2.4f,     0.1f,   -0.2f },
    {10,  4,     -1.0,     5.3f,    -0.0,    0.1f },
    {10,  5,     -0.6f,    -9.1f,    -0.3f,   -0.1f },
    {10,  6,     -0.9f,     0.4f,     0.0,    0.1f },
    {10,  7,      1.5f,    -4.2f,    -0.1f,    0.0 },
    {10,  8,      0.9f,    -3.8f,    -0.1f,   -0.1f },
    {10,  9,     -2.7f,     0.9f,    -0.0,    0.2f },
    {10, 10,     -3.9f,    -9.1f,    -0.0,   -0.0 },
    {11,  0,      2.9f,     0.0,     0.0,    0.0 },
    {11,  1,     -1.5f,     0.0,    -0.0,   -0.0 },
    {11,  2,     -2.5f,     2.9f,     0.0,    0.1f },
    {11,  3,      2.4f,    -0.6f,     0.0,   -0.0 },
    {11,  4,     -0.6f,     0.2f,     0.0,    0.1f },
    {11,  5,     -0.1f,     0.5f,    -0.1f,   -0.0 },
    {11,  6,     -0.6f,    -0.3f,     0.0,   -0.0 },
    {11,  7,     -0.1f,    -1.2f,    -0.0,    0.1f },
    {11,  8,      1.1f,    -1.7f,    -0.1f,   -0.0 },
    {11,  9,     -1.0,    -2.9f,    -0.1f,    0.0 },
    {11, 10,     -0.2f,    -1.8f,    -0.1f,    0.0 },
    {11, 11,      2.6f,    -2.3f,    -0.1f,    0.0 },
    {12,  0,     -2.0,     0.0,     0.0,    0.0 },
    {12,  1,     -0.2f,    -1.3f,     0.0,   -0.0 },
    {12,  2,      0.3f,     0.7f,    -0.0,    0.0 },
    {12,  3,      1.2f,     1.0,    -0.0,   -0.1f },
    {12,  4,     -1.3f,    -1.4f,    -0.0,    0.1f },
    {12,  5,      0.6f,    -0.0,    -0.0,   -0.0 },
    {12,  6,      0.6f,     0.6f,     0.1f,   -0.0 },
    {12,  7,      0.5f,    -0.1f,    -0.0,   -0.0 },
    {12,  8,     -0.1f,     0.8f,     0.0,    0.0 },
    {12,  9,     -0.4f,     0.1f,     0.0,   -0.0 },
    {12, 10,     -0.2f,    -1.0,    -0.1f,   -0.0 },
    {12, 11,     -1.3f,     0.1f,    -0.0,    0.0 },
 ...
 * to double precision before arithmetic.  GMST and jd2year computations are
                        ...
                        double B_ECI[3])
{
    ...
    double theta = gmst_from_jd(JD);   /* Fix 1: computed in double internally */
...
void load_wmm2025(double JD,
                        ...
                        double h[WMM_DIM][WMM_DIM])
{
    double decimalYear = jd2year(JD);   /* Fix 2: double arithmetic inside */
 ...
 * precision loss that occurs when a large JD is held in a double before
 * the cancellation step.
 *
 * \param JD  Julian Date (double precision).
 * \return    Corresponding decimal year as double (e.g. 2025.5f).
 */
double jd2year(double JD)
{
 ...
 * In double this value has a precision of ~0.25, causing up to ~0.25° error
                          ...
                          double*lat_rad, double*lon_rad, double*alt_m)
{
    ...
    *lon_rad = atan2f(y, x);
    ...
    for (int32_t iter = 0; iter < 10; ++iter) {
        ...
        double theta_new = atan2f(z * (1.0 - e2 * N / (N + alt)), p);
        if (fabs(theta_new - theta) < 1.0e-10f) {
            theta = theta_new;
            break;
        }
        theta = theta_new;
                               ...
                               double*B_N, double*B_E, double*B_D)
{
    ...
    double phi_prime = asin(z_gc / r);
    double psi       = lat_rad - phi_prime;

    /* ---- Spherical harmonic synthesis ---- */
    double theta     = (float)(M_PI / 2.0) - phi_prime;
    ...
    for (int32_t n = 1; n <= WMM_NMAX; ++n) {
        ...
        for (int32_t m = 0; m <= n; ++m) {
            ...
            double sin_mlon = sin((float)m * lon_rad);
            double cos_mlon = cos((float)m * lon_rad);
            ...
            if (m > 0 && fabs(sin_theta) > 1.0e-10f) {
