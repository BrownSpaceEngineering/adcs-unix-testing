...
typedef enum { L_1, L_2 } norm_type_t;
...
void linsolvef(double* A, double* X, double* B, int row, int column_b);
...
void cut(double* A, int row, int column, double* B, int start_row, int stop_row, int start_column,
         int stop_column);
...
void insert(double* A, double* B, int row_a, int column_a, int column_b, int startRow_b,
            int startColumn_b);
void move(double* A, int row, int column, int down, int right);
// void quadprog(double* H, double* g, double* A, double* ulb_vec, double*
// uub_vec,  double* ylb_vec, double* yub_vec, int* nWSR, double* u, int
// columnH, int rowA);
void linprog(double* c, double* A, double* b, double* x, int row_a, int column_a, uint8_t max_or_min,
             int iteration_limit);
bool f_eps_close(double a, double b, double epsilon);
bool f_eps_close_default(double a, double b);
bool f_eps_close_matrix(double* A, double* B, int row, int column, double epsilon);
bool f_eps_close_matrix_default(double* A, double* B, int row, int column);
