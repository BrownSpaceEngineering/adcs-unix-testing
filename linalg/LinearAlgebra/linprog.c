...
static void opti(double* c, double* A, double* b, double* x, int row_a, int column_a,
...
static void opti(double* c, double* A, double* b, double* x, int row_a, int column_a,
    ...
    double tableau[(row_a + 1) * (column_a + row_a + 2)]; // +1 because the extra row for objective
